...
description: >
  Export selected WeChat conversations from the local macOS WeChat sandbox data into Obsidian as
  dated, searchable Markdown. Use it when 多多 asks to export specific WeChat chats (never bulk). Always
  confirm the exact conversations to export with 多多 before running, then report what was exported.
agent_created: true
---
