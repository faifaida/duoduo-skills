---
name: duoduo-xhs-weekly-digest
description: >
  Weekly Xiaohongshu (小红书) album digest for the content-ops employee (内容运营): every Tuesday 07:00,
  grab the new notes added to 多多's saved XHS albums and organize them. Uses the xhs-spider-sync /
  xhs-obsidian-import tooling for the pull. Use it for the Tuesday-07:00 content-ops automation
  (expertId duoduo-content-ops). Feeds the content engine with fresh saved-material without manual
  grabbing.
agent_created: true
---
