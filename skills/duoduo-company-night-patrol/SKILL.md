---
name: duoduo-company-night-patrol
description: >
  The 多多个人公司 23:00 night patrol: re-sweep the day's tasks for loose ends, then run the once-daily
  archive triage + pending-review emoji flag (merged from the former archive-file-triage and
  pending-review-emoji-flag skills) together, update HQ status docs, and run a fallback approval-detect
  in case a == == highlight was missed during the day. Use it for the 23:00 夜巡 automation.
agent_created: true
---
