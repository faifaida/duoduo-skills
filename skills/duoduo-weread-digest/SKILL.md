---
name: duoduo-weread-digest
description: >
  Weekly WeChat-Reading (微信读书) digest for the researcher employee (资料员): every Tuesday 09:00,
  pull 多多's highlights from WeChat Reading via the weread-skills tool, summarize them, and organize
  them into reading notes. Use it for the Tuesday-09:00 researcher automation (expertId
  duoduo-researcher). Keeps 多多's reading highlights turned into reusable notes without manual work.
agent_created: true
---
