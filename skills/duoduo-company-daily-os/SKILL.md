---
name: duoduo-company-daily-os
description: >
  The 多多个人公司 daily 13:00 Chief-of-Staff routine: aggregate the three employees' (content-ops /
  researcher / product-manager) prior-day output, produce a briefing + acceptance checklist + next-day
  plan, flag stale pending-review files, dispatch instructions, and detect == == approvals. Per
  多多's 2026-07-26 instruction: the briefing is filed in the 公司简报 folder, and the instruction
  dispatched to each employee is the previous night-patrol's 📩-marked approved next-day plan. Use it for
  the 13:00 总办 automation.
agent_created: true
---
